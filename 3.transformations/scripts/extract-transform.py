...
parquet_path = Path(__file__).parent.parent.parent / "1.data" / "2.processed" / "df_book.parquet"

if parquet_path.exists():
    df_book_stale = pd.read_parquet(parquet_path)
...
df_updated.to_parquet(parquet_path,engine='pyarrow')
df_book = df_updated

parquet_stat_path = Path(__file__).parent.parent.parent / "1.data" / "2.processed" / "stats_lecture.parquet"
...
if os.path.exists(parquet_stat_path):
    df_stat_stale = pd.read_parquet(parquet_stat_path)
...
folder_update_path = Path(__file__).parent.parent.parent / "1.data" / "1.raw" / "sqlite"
folder_archive_path = Path(__file__).parent.parent.parent / "1.data" / "3.archives" / "sqlite"
